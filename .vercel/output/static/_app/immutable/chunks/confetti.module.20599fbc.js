...
`);
	...
	function $(e) {
		...
		return (
			...
			{ r: E(r.substring(0, 2)), g: E(r.substring(2, 4)), b: E(r.substring(4, 6)) }
		);
	}
	function X(e) {
	...
	function tr(e, r) {
		...
		if (
			((e.fillStyle =
				'rgba(' + r.color.r + ', ' + r.color.g + ', ' + r.color.b + ', ' + (1 - a) + ')'),
			e.beginPath(),
			A &&
				r.shape.type === 'path' &&
			...
			m.setTransform(f),
				(e.globalAlpha = 1 - a),
				(e.fillStyle = m),
				e.fillRect(r.x - d / 2, r.y - u / 2, d, u),
				(e.globalAlpha = 1);
			...
			h = P(function (d) {
				...
				function f() {
					B &&
						...
						((t.width = e.width = I.width), (t.height = e.height = I.height)),
						!t.width && !t.height && (a(e), (t.width = e.width), (t.height = e.height)),
	...
	function N(e, r) {
		...
		function m(c) {
			...
			a && u ? (e = u.canvas) : a && !e && ((e = er(p)), document.body.appendChild(e)),
				t && !h && s(e);
			...
			function w() {
				if (n) {
					...
					s(b), n.postMessage({ resize: { width: b.width, height: b.height } });
					return;
				}
			...
			function C() {
				(u = null),
					...
					a &&
						e &&
						(document.body.contains(e) && document.body.removeChild(e), (e = null), (h = !1));
			}
			return (
				t && !o && ((o = !0), M.addEventListener('resize', w, !1)), n ? n.fire(c, y, C) : f(c, y, C)
			);
		}
		return (
			(m.reset = function () {
	...
	function ir(e, r, a, t, o, i, l) {
		...
		return (
			h.addPath(
				s,
				new DOMMatrix([Math.cos(l) * o, Math.sin(l) * o, -Math.sin(l) * i, Math.cos(l) * i, a, t])
			),
			h
		);
	}
	...
	(T.exports = function () {
		...
		(T.exports.create = N),
		(T.exports.shapeFromPath = lr),
		(T.exports.shapeFromText = sr);
})(
	(function () {
...
export { pr as create, Mr as default };
